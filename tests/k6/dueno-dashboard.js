...
export const options = {
  ...
  thresholds: {
    ...
    errors: ['rate<0.01'],
    dashboard_ms: ['p(95)<1000'],
    agenda_diaria_ms: ['p(95)<1200'],
    reportes_ingresos_ms: ['p(95)<1500']
  }
};
...
export default function () {
  ...
  group('Agenda diaria', () => {
    ...
    check(res, {
      'agenda diaria 200': (r) => r.status === 200
    });
  });
  ...
  group('Agenda semanal', () => {
    ...
    check(res, {
      'agenda semanal 200': (r) => r.status === 200
    });
  });
  ...
  group('Reportes ingresos', () => {
    ...
    check(res, {
      'reportes ingresos 200': (r) => r.status === 200
    });
  });
  ...
  group('Estadisticas ocupacion', () => {
    ...
    const res = http.get(`${BASE_URL}/api/dueno/estadisticas/ocupacion?mes=${mes}&anio=${anio}`, params);
    ocupacionTrend.add(res.timings.duration);
    check(res, {
      'ocupacion 200': (r) => r.status === 200
    });
  });
